            ...
            <form onSubmit={handleEmailAuth} className="flex flex-col gap-4 w-full lg:w-auto">
              <div className="flex flex-col lg:flex-row gap-4">
                <input
                  ...
                  required
                  className="px-6 py-4 bg-white/80 backdrop-blur-sm rounded-xl border border-[#e5e5e5] focus:border-[#404040] focus:outline-none transition-colors duration-200 text-[#202020] placeholder:text-[#9a9a9a] min-w-[240px]"
                  style={{ fontFamily: "var(--font-figtree), Figtree" }}
                />
                <input
                  type="password"
              ...
              <button
                type="submit"
                className="px-8 py-4 bg-[#202020] hover:bg-[#404040] text-white rounded-xl transition-colors duration-200 font-medium"
                style={{ fontFamily: "var(--font-figtree), Figtree" }}
              >
                Continue
              </button>
